...
class Affiliatepage1Widget extends StatefulWidget {
  Affiliatepage1Widget({Key key}) : super(key: key);

  @override
  _Affiliatepage1WidgetState createState() => _Affiliatepage1WidgetState();
}

class _Affiliatepage1WidgetState extends State<Affiliatepage1Widget> {
                                    ...
                                    children: [
                                      Expanded(
                                        child: Align(
                                          ...
                                          child: Text(
                                            'And Before You Download The Secret Email System Book… Catch!',
