...
class Affiliatepage7Widget extends StatefulWidget {
  Affiliatepage7Widget({Key key}) : super(key: key);

  @override
  _Affiliatepage7WidgetState createState() => _Affiliatepage7WidgetState();
}

class _Affiliatepage7WidgetState extends State<Affiliatepage7Widget> {
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        'The NEW Growing \"Color By Number\" ',
